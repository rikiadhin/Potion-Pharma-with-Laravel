        ...
        <div class="site-navbar py-2">
            ...
            <div class="container">
                <div class="d-flex align-items-center justify-content-between">
                    <div class="logo">
                        <div class="site-logo">
                            <a href="/landingpage" class="js-logo-clone">Pharma</a>
                        </div>
                    </div>
                    <div class="main-nav d-none d-lg-block">
                        <nav class="site-navigation text-right text-md-center" role="navigation">
                            <ul class="site-menu js-clone-nav d-none d-lg-block">
                                ...
                                <li><a href="/registrasiPembeli">Registrasi</a></li>
                                <!-- <li class="has-children">
                  <a>Registrasi</a>
                    <ul class="dropdown">
                    <li><a href="registrasi_penjual.php">Penjual</a></li>
                    <li><a href="registrasi_pembeli.php">Pembeli</a></li>
                  </ul>
                </li> -->
                            </ul>
                        </nav>
                ...
                <div class="row">
                    <div class="col-lg-7 mx-auto order-lg-2 align-self-center">
                        <div class="site-block-cover-content text-center">
                            ...
                            <h1>Welcome To Potion Pharma</h1>
                            <p>
                                <a href="registrasiPenjual" class="btn btn-primary px-5 py-3">Daftarkan Apotek Anda</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-4 text-center item mb-4">
                        ...
                        <h3 class="text-dark">
                            <a href="/shop-single">Chanca Piedra</a>
                        </h3>
                    ...
                    <div class="col-sm-6 col-lg-4 text-center item mb-4">
                        ...
                        <h3 class="text-dark">
                            <a href="/shop-single">Umcka Cold Care</a>
                        </h3>
                    ...
                    <div class="col-sm-6 col-lg-4 text-center item mb-4">
                        ...
                        <h3 class="text-dark">
                            <a href="/shop-single">Cetyl Pure</a>
                        </h3>
                        <p class="price"><del>45.00</del> &mdash; $20.00</p>
                    </div>
                    <div class="col-sm-6 col-lg-4 text-center item mb-4">
                        <a href="/shop-single">
                            <img src="images/product_05.png" alt="Image" /></a>
                    ...
                    <div class="col-sm-6 col-lg-4 text-center item mb-4">
                        <span class="tag">Sale</span>
                        <a href="/shop-single">
                            <img src="images/product_06.png" alt="Image" /></a>
                        <h3 class="text-dark">
                            <a href="/shop-single">Poo Pourri</a>
                        </h3>
