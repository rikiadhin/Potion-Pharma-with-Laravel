                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card table-card review-card">
                        <div class="card-header ">
                            <h3>Data Toko</h3>
                            <span>Jumlah : {{count($dataToko)}}</span>
                        </div>
                                    ...
                                    <div class="col">
                                        <div class=" mb-3">
                                            <form action="" method="" class="d-flex">
                                                <input type="text" name="" id="keywordobat" autofocus placeholder="Masukkan kata kunci...">
                                                <button type="" name="" class="btn btn-primary btn-sm ml-2">Cari</button>
                                            </form>
                                        </div>
                                            ...
                                            <div class="table-responsive">
                                                <table border="1" cellpadding=10 cellspacing=0>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="table-info">{{ $DetailToko->id_toko }}</td>
                                                            <td class="table-success">{{ $DetailToko->namatoko }}</td>
                                                            <td class="table-warning">{{ $DetailToko->pemilik }}</td>
                                                            <td class="table-danger">{{ $DetailToko->alamat }}</td>
                                                            <td class="table-primary">{{ $DetailToko->usernameUser }}</td>
                                                            <td class="table-danger" style="vertical-align: middle;">
                                                                <div class="row justify-content-center">
                                                                    <a href="{{ url('/admin/update-toko', ['id' => $DetailToko->id_toko]) }}"> <i class="feather icon-edit" style="  font-size: 25px; color: dark;"></i> </a>
                                                                    <a href="{{url('/admin/hapus-data-toko', ['id' => $DetailToko->id_toko] )}}"><i onclick="return confirm('Apakah anda yakin akan menghapus data toko tersebut ?')" class=" pl-3 feather icon-trash-2" style="font-size: 25px; color: red; "></i> </a>
                                                                </div>
                                                            </td>
