                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card table-card review-card">
                        <div class="card-header ">
                            <h3>Data User</h3>
                            <span>Jumlah : {{count($dataPembeli)}}</span>
                        </div>
                        <div class="card-body pb-0">
                            <div class="review-block">
                                <div class="row">
                                    <div class="col">
                                        <div class=" mb-3">
                                            <a href="../obat/tambah_obat.php"><button class="btn btn-success ">Tambah Data</button></a>
                                            <br>
                                            <br>
                                        ...
                                        <div class="card-body table-border-style">
                                            <div class="table-responsive">
                                                <table border="1" cellpadding=10 cellspacing=0>
                                                    ...
                                                    <tbody>
                                                        @foreach($dataPembeli as $DetailPembeli)
                                                        <tr>
                                                            <td class="table-info">{{ $DetailPembeli->userid }}</td>
                                                            <td class="table-success">{{ $DetailPembeli->foto_profil }}</td>
                                                            <td class="table-warning">{{ $DetailPembeli->usernameUser }}</td>
                                                            <td class="table-danger">{{ $DetailPembeli->email }}</td>
                                                            <td class="table-primary">{{ $DetailPembeli->kota }}</td>
                                                            <td class="table-primary">{{ $DetailPembeli->provinsi }}</td>
