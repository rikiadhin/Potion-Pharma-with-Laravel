                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card table-card review-card">
                        <div class="card-header ">
                            <h3>Data User</h3>
                            <span>Jumlah : {{count($dataUser)}}</span>
                        </div>
                        <div class="card-body pb-0">
                            <div class="review-block">
                                <div class="row">
                                    <div class="col">
                                        <div class=" mb-3">
                                            <a href="{{url('/admin/add-user')}}"><button class="btn btn-success ">Tambah Data</button></a>
                                            <br>
                                            <br>
                                            <form action="" method="post" class="d-flex">
                                                <input type="text" name="keywordobat" id="keywordobat" autofocus placeholder="Masukkan kata kunci...">
                                                <button type="submit" name="cari" class="btn btn-primary btn-sm ml-2">Cari</button>
                                            </form>
                                        </div>
                                            ...
                                            <div class="table-responsive">
                                                <table border="1" cellpadding=10 cellspacing=0>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="table-info">{{ $DetailUser->id }}</td>
                                                            <td class="table-success">{{ $DetailUser->fullname }}</td>
                                                            <td class="table-warning">{{ $DetailUser->username }}</td>
                                                            <td class="table-danger">{{ $DetailUser->nomortelepon }}</td>
                                                            <td class="table-primary">{{ $DetailUser->role }}</td>
                                                            <td class="table-danger" style="vertical-align: middle;">
                                                                <div class="row justify-content-center">
                                                                    <a href="{{ url('/admin/update-user', ['id' => $DetailUser->id]) }}"> <i class="feather icon-edit" style="  font-size: 25px; color: dark;"></i> </a>
                                                                    <a href="{{ url('/admin/hapus-user', ['id' => $DetailUser->id, 'role' => $DetailUser->role, 'username' => $DetailUser->username]),  }}"><i onclick="return confirm('Apakah anda yakin akan menghapus data ?')" class=" pl-3 feather icon-trash-2" style="font-size: 25px; color: red; "></i> </a>
                                                                </div>
                                                            </td>
