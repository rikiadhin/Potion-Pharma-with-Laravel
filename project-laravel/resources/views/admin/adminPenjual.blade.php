                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card table-card review-card">
                        <div class="card-header ">
                            <h3>Data User</h3>
                            <span>Jumlah : {{count($dataPenjual)}}</span>
                        </div>
                                        ...
                                        <div class="card-body table-border-style">
                                            <div class="table-responsive">
                                                <table border="1" cellpadding=10 cellspacing=0>
                                                    ...
                                                    <tbody>
                                                        @foreach($dataPenjual as $DetailPenjual)
                                                        <tr>
                                                            <td class="table-info">{{ $DetailPenjual->userid }}</td>
                                                            <td class="table-success">{{ $DetailPenjual->foto_profil }}</td>
                                                            <td class="table-warning">{{ $DetailPenjual->username }}</td>
                                                            <td class="table-danger">{{ $DetailPenjual->email }}</td>
                                                            <td class="table-primary">{{ $DetailPenjual->kota }}</td>
                                                            <td class="table-primary">{{ $DetailPenjual->provinsi }}</td>
