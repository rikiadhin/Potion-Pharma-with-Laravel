                        ...
                        <nav class="site-navigation text-right text-md-center" role="navigation">
                            <ul class="site-menu js-clone-nav d-none d-lg-block">
                                ...
                                <li class="has-children">
                                    ...
                                    <ul class="dropdown">
                                        <li><a href="{{ route('profile', ['username' => Session::get('username')]) }}">Profile</a></li>
                                        <li><a href="{{url('/logout')}}" onclick="return confirm('Apakah anda yakin ingin keluar ?')">Log out</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </nav>
